...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	filterPtr = new  float[MAX_FILTER_WIDTH * MAX_FILTER_HEIGHT * sizeof(float)];
	...
	*****************************************************/
	...
	printf("C Sobel_X Performance (ms) = %f \n", dCpuTime * 1000.0);

	err = fopen_s(&output_fp, "Sobel_X_outfile.raw", "wb");
	if (err != 0) {
...
void conv16(unsigned short* inputPtr, unsigned short* outputConvPtr, float* filterPtr, int kernel_width, int kernel_height,
